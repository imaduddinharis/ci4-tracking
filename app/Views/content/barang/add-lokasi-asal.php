          ...
          <div class="row align-items-start">
            <div class="col-lg-8">
              <div class="page-header-title">
                ...
                <div class="d-inline">
                  <h3 class="m-b-0">Tambah Lokasi Asal</h3>
        ...
        <div class="page-body">
          <div class="card">
            <div class="card-header">
              <h5 style="margin-top:3px!important;">Silahkan input lokasi asal</h5>
            </div>
            <div class="card-block">
                <form method="post" action="/barang/post-lokasi-asal">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <button name="lokasi_asal_add" type="submit" class="btn btn-primary f-right m-l-5">Tambah Lokasi</button>
